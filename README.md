...
**v0.4.0** — Herdr X-Ray CLI (`v0.1.0`) + **Log Tail** popup. CLI: bounded audits, compare, marketplace, receipts. Popup: `Log Tail` — tails all pane logs in workspace, error highlight, `e`/`f`/`filter`, `q`.
